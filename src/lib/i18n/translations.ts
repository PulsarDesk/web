...
const TR: Record<string, string> = {
	...
	'hero.sub':
		'Pulsar; Parsec gibi düşük gecikmeli oyun akışını ve TeamViewer / RustDesk gibi uzaktan masaüstünü tek açık kaynak uygulamada birleştirir. macOS, Windows ve Linux’ta — sonsuza dek ücretsiz.',
...
const EN: Record<string, string> = {
	...
	'hero.sub':
		'Pulsar combines Parsec-style low-latency game streaming with TeamViewer / RustDesk-style remote desktop in a single open-source app. On macOS, Windows and Linux — free forever.',
...
const KK: Record<string, string> = {
	...
	'hero.sub':
		'Pulsar — Parsec тәрізді төмен кідірісті ойын ағынын және TeamViewer / RustDesk тәрізді қашықтағы жұмыс үстелін бір ашық бастапқы кодты қолданбада біріктіреді. macOS, Windows және Linux-те — мәңгі тегін.',
...
const RU: Record<string, string> = {
	...
	'hero.sub':
		'Pulsar объединяет стриминг игр с низкой задержкой в стиле Parsec и удалённый рабочий стол вроде TeamViewer / RustDesk в одном приложении с открытым кодом. На macOS, Windows и Linux — бесплатно навсегда.',
